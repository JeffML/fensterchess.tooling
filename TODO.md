...
**Current State:**  
Migration complete. `fromToPositionIndexed.json` is now generated by `eco.json.tooling` (`fromToPositionIndexed.js`), committed to the `eco.json` repo, and downloaded at runtime by fensterchess. The temporary `scripts/generateFromToIndex.ts` has been removed from this repo.
...
- `eco.json.tooling/fromToPositionIndexed.js` - Canonical generator (post-migration)
